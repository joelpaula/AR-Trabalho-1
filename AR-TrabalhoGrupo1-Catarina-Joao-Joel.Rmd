...
**TO DO SELECIONAR UMA DAS DUAS OU MOSTRAR AMBAS ?**
...
Se considerarmos a *rede não direcionada, então ela é conexa* porque existe um caminho entre qualquer par de nodos.
